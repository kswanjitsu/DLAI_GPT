# the actual script that the function/pipeline can be called from
import spacy
...
@Language.factory("readability", default_config={"case_sensitive": False})
def create_Readability_component(nlp: Language, name: str, case_sensitive: bool):
    return ReadabilityComponent(nlp, case_sensitive)



class ReadabilityComponent:
